                ...
                <div className="grid gap-3 px-10 md:gap-10 md:py-4 md:grid-cols-2">
                    ...
                    <div className="relative flex flex-col">
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                className="border placeholder:text-textcolor border-bordercolor rounded-lg w-full py-4 my-1 pl-16 placeholder:font-poppins placeholder:text-sm placeholder:opacity-50  text-textcolor focus:outline-none focus:ring-1 focus:ring-[#239C57]"
