                                        ...
                                        >
                                            ...
                                            <div className='w-[35%]'>
                                                <input
                                                    ...
                                                    className="border border-[#7fad9344] text-textcolor  font-poppins  bg-transparent border-opacity-10 rounded p-2 w-[80%] text-sm focus:outline-none focus:ring-1 focus:ring-[#239C57]"
                                                />
                                            </div>
