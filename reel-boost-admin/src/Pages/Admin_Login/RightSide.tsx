                ...
                <div className="rounded-lg ">
                    ...
                    <div className="flex flex-col mb-4">
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="email"
                                className=" border border-bordercolor border-opacity-10 rounded-lg w-full py-3 my-1 pl-16 placeholder:font-gilroy_regular placeholder:text-sm placeholder:text-black placeholder:opacity-50 bg-white focus:outline-none focus:ring-1 focus:ring-[#239C57]"
                        ...
                        <div className="relative">
                            ...
                            <span className="h-12 py-4">
                                <input
                                    ...
                                    className="border border-bordercolor  rounded-lg w-full py-3 my-1 pl-16 placeholder:font-gilroy_regular placeholder:text-sm placeholder:text-black placeholder:opacity-50 bg-white focus:outline-none focus:ring-1 focus:ring-[#239C57]"
