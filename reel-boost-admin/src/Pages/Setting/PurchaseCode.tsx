    ...
    return (
        <div className="border border-bordercolor rounded-lg  px-2 md:px-8 py-6 mt-5 md:mt-0">
            ...
            <input
                ...
                value="*************"
                readOnly
                className="border border-bordercolor font-poppins text-textcolor bg-transparent rounded-md w-full py-3 my-1 px-4 placeholder:font-gilroy_regular placeholder:text-sm placeholder:text-textcolor placeholder:opacity-50 focus:outline-none focus:ring-1 focus:ring-[#239C57]"
            />
